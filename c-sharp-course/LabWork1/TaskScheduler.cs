...
namespace LabWork1
{
    public class TaskScheduler
    {
        ...
        private void ResetTasks(IEnumerable<UserTask> userTask)
        {
            ClearTasks();
        ...
        public void ClearTasks() => TaskManager.Clear();
        public void PrintTasks() => TaskManager.Print();
        public void PrintHistory() => HistoryManager.Print();
        ...
        public string AddTask(UserTask task)
        {
            ...
            var scheduled = new LabWork1.TasksManaging.Task(CalcExecutionTime(task), task);
            try
            {
