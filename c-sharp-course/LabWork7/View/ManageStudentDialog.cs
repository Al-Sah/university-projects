...
namespace LabWork7.View
{
    public partial class ManageStudentDialog : Form
    {
        ...
        {
            if (NameTextBox.Text == string.Empty || GroupsListBox.SelectedItem == null ||
                GroupsListBox.SelectedItem.ToString() == string.Empty)
            {
                MessageBox.Show("Failed to create student; Input contains emty fields", "Ups", MessageBoxButtons.OK,
